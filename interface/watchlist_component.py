...
class Watchlist(tk.Frame):
    def __init__(self, binance_contracts: typing.Dict[str, Contract], *args, **kwargs):
        ...
        self.binance_label = tk.Label(self._commands_frame, text="Binance", bg=BG_COLOR, fg=FG_COLOR, font=BOLD_FONT)
        self.binance_label.grid(row=0, column=0)

        self.binance_entry = tk.Entry(self._commands_frame, fg=FG_COLOR, justify=tk.CENTER, 
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['symbol'][b_index] = tk.Label(self._table_frame, text=symbol, bg=BG_COLOR,
        ...
        self.body_widgets['remove'][b_index] = tkmac.Button(self._table_frame, text="X", 
